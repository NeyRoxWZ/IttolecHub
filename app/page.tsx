...
export default function Home() {
  ...
  return (
    <div className="h-screen bg-[#0F172A] text-[#F8FAFC] font-sans selection:bg-indigo-500/30 overflow-hidden flex flex-col items-center justify-center relative p-4">
      ...
      <main className="relative z-10 w-full max-w-6xl flex flex-col items-center gap-8 animate-in fade-in zoom-in duration-500 overflow-hidden">
        ...
        <div className="text-center">
          <img 
            src="/logosite.png"
            alt="IttolecHub" 
            className="h-40 md:h-56 w-auto mx-auto logo-flottant"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
            ...
            <div className="bg-[#1E293B] border border-[#334155] rounded-[2.5rem] p-8 shadow-[4px_4px_0px_0px_#020617] flex flex-col h-full min-h-[500px]">
                
                {/* TABS */}
                <div className="flex bg-[#0F172A] p-2 rounded-xl mb-6 border border-[#334155]">
                    <button 
                        onClick={() => setActiveTab('create')}
                        className={`flex-1 py-3 text-xl font-bold uppercase tracking-wider rounded-lg transition-all duration-100 ${
                            activeTab === 'create' 
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-8">
                    ...
                    <div className="w-36 h-36 rounded-full bg-[#0F172A] border-4 border-[#334155] flex items-center justify-center mb-4">
            ...
            <div className="bg-[#1E293B] border border-[#334155] rounded-[2.5rem] p-8 shadow-[4px_4px_0px_0px_#020617] flex flex-col h-full min-h-[500px] relative overflow-hidden">
                { /* decorative line removed to clean UI as requested */ }
                
                <h2 className="text-2xl font-bold text-center text-[#F8FAFC] uppercase tracking-widest mb-6">
                    COMMENT JOUER
                </h2>
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center relative">
                    ...
                    <div className="z-10 w-full max-w-sm">
                        <div className="mb-6 h-40 w-full flex items-center justify-center">
                            <div className="w-full h-full bg-[#0F172A] border-4 border-[#334155] rounded-2xl flex items-center justify-center relative overflow-hidden transition-all duration-500">
                                ...
                                {currentStep === 0 && (
                                    <div className="relative w-full h-full flex items-center justify-center gap-4">
                                        ...
                                        <div className="w-20 h-20 bg-[#3B82F6] rounded-full border-4 border-white flex items-center justify-center animate-bounce shadow-[4px_4px_0px_0px_#020617]" style={{ animationDelay: '0s' }}>
                                            <Users className="w-10 h-10 text-white" />
                                        </div>
                                        <div className="w-20 h-20 bg-[#6366F1] rounded-full border-4 border-white flex items-center justify-center animate-bounce shadow-[4px_4px_0px_0px_#020617]" style={{ animationDelay: '0.2s' }}>
                                            <Users className="w-10 h-10 text-white" />
                                        </div>
                                        <div className="w-20 h-20 bg-green-500 rounded-full border-4 border-white flex items-center justify-center animate-bounce shadow-[4px_4px_0px_0px_#020617]" style={{ animationDelay: '0.4s' }}>
                                            <Users className="w-10 h-10 text-white" />
                                        </div>
                                    </div>
                                )}
                        ...
                        <h3 className="text-2xl font-bold text-[#F8FAFC] mb-3 uppercase tracking-wide min-h-[40px]">
                            {STEPS[currentStep].title}
                        </h3>
                        <p className="text-lg text-[#94A3B8] font-medium leading-relaxed min-h-[50px]">
