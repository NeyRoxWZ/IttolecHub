      ...
      >
          ...
          {currentPhase === 'setup' && (
              <div className="flex flex-col items-center justify-center space-y-6 animate-in fade-in zoom-in duration-500">
                  <div className="p-6 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full shadow-2xl animate-bounce">
                      <Home className="w-16 h-16 text-white" />
                  </div>
                  <h2 className="text-3xl font-bold text-slate-800 dark:text-slate-100">Prêt à estimer des loyers ?</h2>
                  ...
                  {isHost ? (
                      <Button onClick={startRound} size="lg" className="w-full max-w-sm text-lg h-14 rounded-xl shadow-xl shadow-indigo-500/20">
                          Commencer la partie
                      </Button>
                  ) : (
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                          <div className="bg-white dark:bg-slate-800 p-3 rounded-xl border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center text-center">
                              ...
                              <span className="text-xs text-slate-500 uppercase font-bold">Surface</span>
                              <span className="font-bold text-slate-800 dark:text-slate-100">{currentProperty?.surface_m2} m²</span>
                          </div>
                          <div className="bg-white dark:bg-slate-800 p-3 rounded-xl border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center text-center">
                              <Building2 className="w-5 h-5 text-purple-500 mb-1" />
                              <span className="text-xs text-slate-500 uppercase font-bold">Pièces</span>
                              <span className="font-bold text-slate-800 dark:text-slate-100">{currentProperty?.nb_rooms}</span>
                          </div>
                          <div className="bg-white dark:bg-slate-800 p-3 rounded-xl border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center text-center">
                              <Bed className="w-5 h-5 text-pink-500 mb-1" />
                              <span className="text-xs text-slate-500 uppercase font-bold">Chambres</span>
                              <span className="font-bold text-slate-800 dark:text-slate-100">{currentProperty?.nb_bedrooms}</span>
                          </div>
                          <div className="bg-white dark:bg-slate-800 p-3 rounded-xl border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center text-center">
                              <Home className="w-5 h-5 text-green-500 mb-1" />
                              <span className="text-xs text-slate-500 uppercase font-bold">Type</span>
                              <span className="font-bold text-slate-800 dark:text-slate-100 truncate w-full">{currentProperty?.property_type}</span>
                          </div>
                      </div>
                  </div>
                              ...
                              return (
                                  <div key={p.player_id} className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 flex items-center justify-between shadow-sm">
                                      ...
                                      <div className="text-right">
                                          <div className="font-black text-xl text-indigo-600 dark:text-indigo-400">
                                              {p.score} pts
                                          </div>
                                      </div>
                                  </div>
