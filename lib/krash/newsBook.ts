...
export const TEMPLATES: NewsTemplate[] = [
  ...
  { id: 'k-meme-viral', category: 'crypto', certainty: 'ambigue',
    ...
    targets: [{ sector: 'crypto_meme', up: 0.7, strength: 0.1 }] },
  ...
  { id: 'r-interdit-meme', category: 'rumeur', certainty: 'ambigue',
    ...
    targets: [{ sector: 'crypto_meme', up: 0.3, strength: 0.12 }] },
    ...
    root: {
      ...
      next: [
        ...
        { weight: 0.45, node: {
          ...
          targets: [{ sector: 'crypto_meme', up: 0.18, strength: 0.1 }],
        } },
      ],
    },
  },
